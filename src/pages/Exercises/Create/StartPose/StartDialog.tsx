...
import { z } from 'zod'
import StartPoseLandmarkPreview from './components/poselandmark-preview'

export default function StartSelectPoseDialog() {
  ...
  const setOpenDialog = useSetAtom(openStartDialogAtom)
